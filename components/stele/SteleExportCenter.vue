...
import { buildDeliveryDto, validateRawDocument } from '../../utils/stele/document-contract';
...
const deliveryVisible=ref(false),busy=ref(false),deliveryDto=ref<Readonly<DeliveryDto>|null>(null),deliveryDom=ref<HTMLElement|null>(null);
